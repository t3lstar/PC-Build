...
- Keep a note of driver versions in the [Drivers Appendix](/PC-Build/appendix/drivers/).

## Step-by-Step Instructions

![Driver installation order diagram](/PC-Build/assets/diagrams/svg/driver-order.svg)

Diagram source: [driver-order.mmd](/PC-Build/assets/diagrams/mermaid/driver-order.mmd)
...
Continue to [EXPO Memory Setup](/PC-Build/build-guide/expo/).
