...
Use the [connector and cable reference](/PC-Build/appendix/connectors-cables/) to distinguish 24-pin ATX, CPU EPS, PCIe GPU power, and optional SATA power cables.
...
![PSU cable routing](/PC-Build/assets/diagrams/svg/psu-cable-routing.svg)
...
Continue to [Motherboard Installation](/PC-Build/build-guide/motherboard-installation/).
