...
Use the [connector and cable reference](/PC-Build/appendix/connectors-cables/) for cable identity, routing dependencies, and do-not-use rules.
...
![Cable routing map](/PC-Build/assets/diagrams/svg/cable-routing.svg)
...
Continue to [Front Panel Connectors](/PC-Build/build-guide/front-panel-connectors/).
