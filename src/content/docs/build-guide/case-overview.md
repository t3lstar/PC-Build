...
![Fan layout](/PC-Build/assets/diagrams/svg/fan-layout.svg)

![Airflow direction](/PC-Build/assets/diagrams/svg/airflow.svg)

Diagram source: [airflow.mmd](/PC-Build/assets/diagrams/mermaid/airflow.mmd)
...
Continue to [Tools](/PC-Build/build-guide/tools/).
