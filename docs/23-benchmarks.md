...
- The monitoring log from [Gaming Optimisation](22-gaming-optimisation.md).
...
- CPU, GPU, and SSD temperatures are consistent with the [temperature reference](appendix/temperature-reference.md) and the observed cooling behaviour.
