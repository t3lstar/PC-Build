...
Provide preparation, installation, first boot, BIOS, Windows, driver, benchmark, and maintenance checklists.

## Pre-Build

- [ ] Bill of materials reviewed.
- [ ] Exact component models confirmed.
- [ ] Tools gathered.
- [ ] Anti-static plan ready.
- [ ] Windows 11 Pro USB installer available.
- [ ] Workspace clean and well lit.
- [ ] Manuals available.

## Motherboard Prep

- [ ] CPU installed.
- [ ] RAM installed in `A2` and `B2`.
- [ ] SSD installed under motherboard heatsink.
- [ ] Socket cover stored.
